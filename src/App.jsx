...
function App() {
  const images = [
    ...
    {
      original: imgSlider7,
      thumbnail: imgSlider7,
    },
    {
      original: imgSlider8,
      thumbnail: imgSlider8,
    },
  ];
  return (
    <>
      <main className="w-full font-raleway overflow-hidden">
        <section
          id="home"
          className="relative h-5/6 w-full pt-6 flex flex-col justify-between md:flex-row"
        >
        ...
        >
          ...
          <picture className="w-full h-auto flex justify-end items-end -mt-32 md:w-auto md:mt-0">
            <img className="max-w-56 md:max-w-80" src={imgPlayer} alt="" />
          </picture>
          <picture className="w-full h-auto flex justify-start items-end -mt-28 md:justify-center mb-8 md:w-auto">
            <img className="max-w-56 md:max-w-80" src={mapaCalor} alt="" />
          </picture>
        </section>
        ...
        >
          <picture className="w-full flex justify-center items-center mb-6 lg:mb-10">
            <img className="max-w-52 lg:max-w-64" src={video} alt="" />
          </picture>
